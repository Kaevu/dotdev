async function renderStats(max = 200) {
  ...
  // Openings bar
  const openingsEl = document.getElementById('openingsChart');
  if (openingsEl && window.Chart) {
  ...
  // Opponent buckets
  const oppEl = document.getElementById('oppRatingChart');
  if (oppEl && window.Chart) {
