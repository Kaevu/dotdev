...
// Adapted from Rare UI's Fluid Orb (free to use; attribution appreciated).
// Source: https://rareui.com/r/fluid-orb.json
// Changes: removed Next.js 'use client' directive and the @/lib/utils `cn`
// dependency; added a static CSS gradient fallback behind the canvas for
  ...
  return (
    <div
      ...
      style={{
        width: size,
        height: size,
        // Static fallback: visible if WebGL is unavailable.
        background: `radial-gradient(circle at 50% 30%, #ffffff 0%, ${color} 78%)`,
        ...style,
      }}
      {...props}
    >
